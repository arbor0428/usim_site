		...
		<div class="c_center">
			<div class="whtBox">
				...
				<div class="slider-cont">
					...
					<input id="ser02" type="text" data-slider-ticks="[0, 100, 200, 300, 400]" data-slider-value="[0, 400]" data-slider-lock-to-ticks="true"/>
				...
				<div class="slider-cont">
					...
					<input id="ser03" type="text" data-slider-ticks="[0, 100, 200, 300, 400]" data-slider-value="[0, 400]" data-slider-lock-to-ticks="true"/>
					<ul class="slidebar_tit dp_sb widdif">
						<li class="txt-c">1GB<br> 미만</li>
						<li class="txt-c">1~2GB</li>
						<li class="txt-c">2~5GB</li>

	...
	<div class="wht01 p-50 p_50">
        <div class="l_center">
            ...
            <div class="inputWrap l_inputWrap">
                ...
                <input id="nm" type="text" placeholder="이름">
            </div>
            <div class="inputWrap l_inputWrap">
                <p class="labelTit bold">휴대폰 번호</p>
                <div class="inputBtnWrap dp_sb m_15">
                    <input type="text" placeholder="휴대폰 번호">
                    <a class="dp_f dp_c dp_cc gry03 " href="" title="전송">전송</a>
                </div>
                <div class="inputBtnWrap dp_sb">
                    <input type="text" placeholder="000000">
                    <a class="dp_f dp_c dp_cc dark01 c_w" href="" title="확인">확인</a>
                </div>
            </div>
            ...
            <a class="submitBtn gradient c_w" href="./join_fin.php" title="가입">가입</a>
        </div>
    </div>
</div>

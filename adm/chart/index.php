		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form name='frm01' id='frm01' method='post' action='/adm/chart/'>
					...
					<h6 class="m-0 font-weight-bold text-info"><i class="far fa-calendar-check"></i> <?=$f_year?>년 누계 (<?=number_format($dataCnt)?>건)</h6>

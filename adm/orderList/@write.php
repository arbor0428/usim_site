			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='zTable'>
				<tr>
					...
					<td width='83%'>
						...
						?>
							<option value="<?=$db_cade03?>" style='padding:5px;' <?=$chk?>><?=$db_cade0f?></option>
						<?
									}
								}
							}
				...
				<tr>
					...
					<td>
						<select name="prod" id="prod" class="form-control" style="width:403px;display:inline-block;">
							<option value=''>주문상품선택</option>
						</select>
					</td>
				</tr>
			</table>
...
<div class="card shadow mb-4" style='margin-top:10px;width:100%;max-width:1000px;'>
	...
	<div class="card-body" style='width:100%;max-width:1000px;'>
		<div class="mb20 clearfix">
			...
			?>
				<tr id='prod<?=$i?>'>
					<td align='center'><img src='/upfile/<?=$item['upfile01']?>' style='width:100px;'></td>
					<td>
					...
					<?
						if($v['status'] == '반품요청'){
					?>
						<a href="javascript:formModal('반품사유',<?=$i?>);" class='btn btn-info btn-circle btn-sm' style='margin-top:5px;' title='반품사유'>
							<i class='fas fa-exclamation-triangle'></i>
						</a>
					<?
						}elseif($v['status'] == '재신청'){
					?>
						<a href="javascript:formModal('재신청사유',<?=$i?>);" class='btn btn-warning btn-circle btn-sm' style='margin-top:5px;' title='재신청사유'>
							<i class='fas fa-exclamation-triangle'></i>
						</a>
					<?
						}
		...
		<div class="mb20 clearfix">
			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='zTable'>
				...
				<tr>
					...
					<td width='33%'><input type="text" name="phone" id="phone" class="form-control" value="<?=$phone?>"></td>
				</tr>
				<tr>
